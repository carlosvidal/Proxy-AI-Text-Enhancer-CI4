...
class AddStatusToUsageLogs extends Migration
{
    public function up()
    {
        ...
        // Copy existing data
        $this->db->query("INSERT INTO usage_logs_new (id, tenant_id, user_id, external_id, button_id, provider, model, has_image, status, tokens, created_at)
                         SELECT id, tenant_id, user_id, external_id, button_id, provider, model, has_image,
                                'success' as status,
                                tokens, created_at
                         FROM usage_logs");
        ...
        $this->db->query('CREATE INDEX idx_usage_logs_status_' . $timestamp . ' ON usage_logs(status)');
    ...
    public function down()
    {
        ...
        $this->db->query("INSERT INTO usage_logs_new (id, tenant_id, user_id, external_id, button_id, provider, model, has_image, tokens, created_at)
                         SELECT id, tenant_id, user_id, external_id, button_id, provider, model, has_image, tokens, created_at
                         FROM usage_logs");
