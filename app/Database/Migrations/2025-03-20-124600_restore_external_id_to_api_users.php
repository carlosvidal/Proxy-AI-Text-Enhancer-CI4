...
class RestoreExternalIdToApiUsers extends Migration
{
    public function up()
    {
        ...
        // Copy existing data, using user_id as external_id
    ...
    {
        // Since we're just restoring a critical field, down migration should not be used
        return;
    }
}
