...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <h2>Add User to <?= esc($tenant['name']) ?></h2>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?= site_url('tenants/add_user/' . $tenant['id']) ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="user_id" name="user_id" value="<?= set_value('user_id') ?>" required>
                <div class="form-text">Unique identifier for this user (e.g. username, email, UUID)</div>
            </div>
