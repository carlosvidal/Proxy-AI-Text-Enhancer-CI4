...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <a href="<?= site_url('tenants/users/' . $tenant_id) ?>" class="btn btn-secondary btn-sm mb-2">
...
<div class="card">
    ...
    <div class="card-body">
        <?php if (empty($usage_logs)): ?>
            <p class="text-muted text-center">No hay registros de uso para este usuario en los últimos 30 días.</p>
        <?php else: ?>
