    ...
    <div class="card-body">
        <form action="<?= site_url('admin/tenants/create') ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="tenant_id" name="tenant_id" value="<?= old('tenant_id') ?>" required>
                <small class="text-muted">A unique identifier for the tenant. This will be used in API calls.</small>
            </div>
